...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemContainer = __webpack_require__(161);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function addNewItem(newItem) {
	      this.setState({ allItems: [].concat(_toConsumableArray(this.state.allItems), [newItem]) });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_ItemContainer2.default, { allItems: this.state.allItems }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function (_Component) {
	  ...
	  function Form(props) {
	    ...
	    _this.handleNameEntry = _this.handleNameEntry.bind(_this);
	    _this.handleCostEntry = _this.handleCostEntry.bind(_this);
	  ...
	  _createClass(Form, [{
	    key: 'handleNameEntry',
	    value: function handleNameEntry(event) {
	      this.setState({ name: event.target.value });
	    }
	  }, {
	    key: 'handleCostEntry',
	    value: function handleCostEntry(event) {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              'Please fill in all text fields. (Original Cost must be positive.)'
	            ),
	            _react2.default.createElement('input', { type: 'submit', value: 'Create Item', className: 'submit-button' })
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemTile = __webpack_require__(162);

	var _ItemTile2 = _interopRequireDefault(_ItemTile);
	...
	var ItemContainer = function (_Component) {
	  ...
	  _createClass(ItemContainer, [{
	    key: 'render',
	    value: function render() {
	      var itemList = this.props.allItems.map(function (item) {
	        return _react2.default.createElement(_ItemTile2.default, {
	          key: item.id,
	          id: item.id,
	          name: item.name,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OriginalCost = __webpack_require__(164);

	var _OriginalCost2 = _interopRequireDefault(_OriginalCost);

	var _UsesDiv = __webpack_require__(165);

	var _UsesDiv2 = _interopRequireDefault(_UsesDiv);

	var _CostPerUse = __webpack_require__(166);

	var _CostPerUse2 = _interopRequireDefault(_CostPerUse);
	...
	var ItemTile = function (_Component) {
	  _inherits(ItemTile, _Component);

	  function ItemTile(props) {
	    _classCallCheck(this, ItemTile);

	    var _this = _possibleConstructorReturn(this, (ItemTile.__proto__ || Object.getPrototypeOf(ItemTile)).call(this, props));

	    _this.state = {
	      uses: 1,
	      costPerUse: _this.props.originalCost
	    };
	  ...
	  _createClass(ItemTile, [{
	    key: 'add',
	    value: function add() {
	      var newUses = this.state.uses + 1;
	      var newCostPerUse = this.props.originalCost / newUses;
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('hr', null),
	          _react2.default.createElement(_CostPerUse2.default, { costPerUse: this.state.costPerUse })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OriginalCost = function OriginalCost(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      null,
	      '$',
	      props.originalCost.toFixed(2)
	    )
	  );
	};

	exports.default = OriginalCost;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsesDiv = function (_Component) {
	  _inherits(UsesDiv, _Component);

	  function UsesDiv(props) {
	    _classCallCheck(this, UsesDiv);

	    return _possibleConstructorReturn(this, (UsesDiv.__proto__ || Object.getPrototypeOf(UsesDiv)).call(this, props));
	  }

	  _createClass(UsesDiv, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              "button",
	              { onClick: this.props.subtract, className: "small-4 columns" },
	              " - "
	            ),
	            _react2.default.createElement(
	              "h3",
	              { className: "text-center small-4 columns" },
	              this.props.uses
	            ),
	            _react2.default.createElement(
	              "button",
	              { onClick: this.props.add, className: "small-4 columns" },
	              " + "
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CostPerUse = function CostPerUse(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      null,
	      '$',
	      props.costPerUse.toFixed(2)
	    )
	  );
	};

	exports.default = CostPerUse;
